...
G1 H1 X125 F2000          ; home X axis
G1 H1 Y125 F2000          ; home Y axis
G1 X-5 Y-5 F7000      ; go back a few mm
G1 H1 X125 Y125 F360       ; move slowly to X axis endstop once more (second pass)

G90				      ; abs pos
G1 X57 Y57 F7000      ; Go to middle of bed.
G91				      ; rel pos
G1 H1 Z-125 F2000     ; move Z down until the endstop is triggered
G1 Z5 F3000			  ; move back
G1 H1 Z-125 F360      ; move Z down stopping at the endstop
G90                   ; absolute positioning
G92 Z0.2              ; set Z position to axis minimum (you may want to adjust this)
